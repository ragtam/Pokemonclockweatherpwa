  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 bg-white/20 backdrop-blur-lg p-3 rounded-full border-2 border-white/30 shadow-lg hover:bg-white/30 transition-all"
      ...
      {/* Info Banner */}
      {showInfo && (
        <div className="fixed top-4 left-4 right-20 z-40 bg-blue-600/90 backdrop-blur-lg p-4 rounded-2xl border-2 border-white/30 shadow-xl">
          <div className="flex items-start gap-3">
            <Info size={24} className="text-white flex-shrink-0 mt-0.5" />
            <div className="text-white">
              <p className="font-semibold mb-1">Welcome to Pokemon Weather Clock! ⚡</p>
              <p className="text-sm text-white/90">
                Swipe left/right to navigate • {wakeLockSupported ? 'Screen will stay awake ✓' : 'Wake Lock not supported'}
              </p>
            </div>
            <button
